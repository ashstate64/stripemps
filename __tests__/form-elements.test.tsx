...
import { FormField, canadianProvinces } from '@/components/application-form/form-elements';
...
describe('Canadian Provinces', () => {
  it('includes all Canadian provinces and territories', () => {
    ...
    expect(canadianProvinces).toContainEqual({ value: 'BC', label: 'British Columbia' });
    expect(canadianProvinces).toContainEqual({ value: 'AB', label: 'Alberta' });
    expect(canadianProvinces).toContainEqual({ value: 'MB', label: 'Manitoba' });
    expect(canadianProvinces).toContainEqual({ value: 'SK', label: 'Saskatchewan' });
    expect(canadianProvinces).toContainEqual({ value: 'NS', label: 'Nova Scotia' });
    expect(canadianProvinces).toContainEqual({ value: 'NB', label: 'New Brunswick' });
    expect(canadianProvinces).toContainEqual({ value: 'NL', label: 'Newfoundland and Labrador' });
    expect(canadianProvinces).toContainEqual({ value: 'PE', label: 'Prince Edward Island' });
    expect(canadianProvinces).toContainEqual({ value: 'NT', label: 'Northwest Territories' });
