...
import { Brain, ArrowLeft, Shield, Phone, Mail } from 'lucide-react';
...
export default function ApplyPage() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-gray-900 font-sans text-gray-200'>
      ...
      <header className='sticky top-0 z-50 border-b border-slate-800/50 bg-slate-950/95 backdrop-blur-xl shadow-2xl'>
            ...
            <div className='flex items-center space-x-3'>
              <div className='openai-logo-container'>
                <Image
                  ...
                  width={32}
                  height={32}
                  className='openai-logo-image md:w-8 md:h-8'
                />
              </div>
              <div>
        ...
        <div className='mx-auto mb-8 max-w-4xl text-center'>
          <div className='mb-6'>
            ...
            <p className='mt-4 text-lg text-gray-300 md:text-xl'>
              Secure your allocation in the most anticipated AI investment opportunity.
            </p>
          </div>
        ...
        <div className='mx-auto max-w-6xl'>
          <div className='mb-6 grid grid-cols-1 gap-6 md:grid-cols-2'>
            ...
            <div className='rounded-lg bg-slate-800/40 p-4'>
              <h4 className='mb-3 text-lg font-semibold text-white'>Need Help?</h4>
              <div className='space-y-2 text-sm'>
                <p className='flex items-center justify-center md:justify-start'>
                  <Phone className='mr-2 h-4 w-4 text-blue-400' />
                  <a href='tel:+14375235816' className='text-blue-400 hover:text-blue-300'>
                    +1 437 523 5816
                  </a>
                </p>
                <p className='flex items-center justify-center md:justify-start'>
                  <Mail className='mr-2 h-4 w-4 text-blue-400' />
                  <a href='mailto:accounts@cgfinancialcanada.ca' className='text-blue-400 hover:text-blue-300'>
            ...
            {/* Security Notice */}
            <div className='rounded-lg bg-slate-800/40 p-4'>
              <h4 className='mb-3 text-lg font-semibold text-white'>Application Security</h4>
          ...
          <div className='border-t border-slate-700 pt-6'>
            <p className='text-xs text-gray-500'>
              This application does not constitute an offer to sell or purchase securities. 
              Investment opportunities are subject to availability and investor qualification.
            </p>
            <p className='mt-2 text-xs text-gray-600'>
              &copy; {new Date().getFullYear()} CG Financial Canada. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
